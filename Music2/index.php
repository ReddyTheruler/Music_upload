			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					...
					if(isset($_SESSION["user"])){
						echo '<a href="dashboard.php"><button class="btn btn-success btn-lg "><span class="glyphicon glyphicon-cog"></span> <b>Dashboard' ; 
					}
					else{
	...
	<div class="modal-dialog">
		<div class="modal-content text-center"> 
			...
			<div class="modal-body" id="modal-body-bg">
				<form method="post" action="dashboard.php" class="text-center" id="form" >
					<div class="input-group">
						<span class="input-group-addon">
						<i class="glyphicon glyphicon-user"></i>
						</span>
					<input type="text" class="form-control" name="user" placeholder="music@gmail.com">
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">
...
<nav class="navbar navbar-inverse navbar-fixed-bottom text-center" id="bottomfooter">
	<h5><b> <span class="glyphicon glyphicon-heart"></span> </b></h5>
</nav>
